...
export default (() => {
	return <Theme theme={theme}>
		...
		<Image height="388.32px" src="https://uploads.quarkly.io/6075c8436de461001eb86de1/images/Rectangle%2014%20(1).png?v=2021-04-13T16:48:38.504Z" width="388.32px" margin="0px 0px 0px 60px" />
		<Box
			width="383.32px"
			height="241.15px"
